...
def run_analysis(file_bytes):
    ...
    # NHẬP THÊM: chỉ xét hàng năm 2024-2026
    agg_nt = agg[agg['danh_gia'] == 'BÁN CHẠY'].copy()
    agg_nt['nam_hang'] = agg_nt['ma_hang'].apply(get_product_year)
    agg_nt = agg_nt[agg_nt['nam_hang'].between(2024, 2026)]
